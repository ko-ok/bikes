    ...
    return (
      <Row id="what" className="section parallax__layer parallax__layer--base">
        <Col className="main" xs={12} md={12}>
          <Row>
            <Col className="col-bi" md={6} xs={11}>
              ...
              <p className="reason-p"> Yet as we find some different but still quiet clamshells on this trip, we hope to help in small handfuls. We will be raising money for the Canadian Premature Babies Foundation. Please feel free to donate. Nothing is too little, the big evidence being found in us.</p>
              <a className="donate-btn" href="https://donorbox.org/ease-to-east" target="_blank"><button name="submit" alt="PayPal - The safer, easier way to pay online!" className="donate">Donate</button></a>
            </Col>
            <Col className="col-bi img-di" xs={11} md={6}>
              <Row>
                <Col xs={11} md={12}>
              ...
              <Row>
                <Col className="pic-col" xs={11} md={6}>
